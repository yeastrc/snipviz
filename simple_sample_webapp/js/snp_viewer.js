...
//      requestParamsCreateRoot = { newick:  , sequences: , requestType: , requestTypeLabel: }

//			newick = String containing newick representation of clustering data

//          sequences = object containing strains and sequences = { "strain1": "seq1", "strain2": "seq2", ... }
...
//					console.log( itemToLog );
			...
			if ( newickString === undefined || newickString === "" ) {

				throw "requestParams.newick must be set to a value";
			}
...
// 
			...
			var getSequencesInStrainOrder = function ( leafs /* array of node */, sequencesInObject ) {
				...
				for(count = 0; count < leafs.length; count++){
					...
					if ( sequenceInObject === undefined || sequenceInObject === null ) {
						...
						throw "ERROR: Strain name in newick file not provided in object containing sequences, strain name = '" + strainName + "'";
					}
			...
			var mainHTML =
				...
				'		<div id="barChartStrainsDendrogramBlock' + SNPIDCounterAppend + '" class="barchart" >' +
				'			<div id="SequencesShowingBlock' + SNPIDCounterAppend + '" style="display: hidden;">' +
				'				Showing' +
			...
			var updatedTree = updateTreeWithPositionEtc( treeParsedNewick );

			var strainList = updatedTree.leafs;

			putStrainsInDOM( strainList );
			...
			try {
				...
				globalVariables.sequencesInStrainOrder = getSequencesInStrainOrder( updatedTree.leafs, sequencesObject );
